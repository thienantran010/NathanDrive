    ...
    <div class="header">
      <div class="header-content">
        <div class="logo" @click="jump">
          ...
          <span class="name">Nathan Drive</span>
        </div>
      </div>
    </div>
        ...
        <div class="share-panel">
          <div class="share-user-info">
            ...
            <div class="share-info">
              <div class="user-info">
                ...
                <span class="share-time">share at {{ shareInfo.shareTime }}</span>
              </div>
              <div class="file-name">share file：{{ shareInfo.fileName }}</div>
            </div>
          </div>
          <div class="share-op-btn">
            <el-button
              ...
              @click="cancelShare"
              ><span class="iconfont icon-cancel"></span>cancel share</el-button
            >
            <el-button
              v-else
              type="primary"
...
//取消分享
const cancelShare = () => {
  proxy.Confirm(`do you really want to cancel share？`, async () => {
    let result = await proxy.Request({
      url: api.cancelShare,
      params: {
        shareIds: shareId,
    ...
    proxy.Message.success("cancel share success");
    router.push("/");
  });
};
